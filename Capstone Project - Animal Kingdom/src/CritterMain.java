...
//         uncomment each of these lines as you complete these classes
         frame.add(8, Bear.class);
         frame.add(8, Tiger.class);
         frame.add(8, WhiteTiger.class);
         frame.add(8, Giant.class);
         frame.add(8, NinjaCat.class);

        frame.add(2, FlyTrap.class);
        frame.add(4, Food.class);
